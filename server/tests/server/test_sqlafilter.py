...
def test_sqlafilter():
    ...
    check(
        'A.a=="a" AND B.b=="b"',
        {"and": [{"model": "A", "field": "a", "op": "==", "value": "a"}, {"model": "B", "field": "b", "op": "==", "value": "b"}]},
    )
    check(
    ...
    check(
        'A.a=="a" OR B.b=="b" OR C.c!="c" AND D.d=="d"',
        {
            "or": [
                {"model": "A", "field": "a", "op": "==", "value": "a"},
                {"model": "B", "field": "b", "op": "==", "value": "b"},
                {"and": [{"model": "C", "field": "c", "op": "!=", "value": "c"}, {"model": "D", "field": "d", "op": "==", "value": "d"}]},
            ]
        },
    )
    ...
    check(
        ...
        {
            "or": [
                {"and": [{"model": "A", "field": "a", "op": "==", "value": "a"}, {"model": "B", "field": "b", "op": "in", "value": [1, 2]}]},
