...
def test_vulnsearch_list_route(frontend_server, sl_operator, vulnsearch):  # pylint: disable=unused-argument
...
def test_vulnsearch_list_route_annotate(frontend_server, sl_operator, vulnsearch):  # pylint: disable=unused-argument
...
def test_vulnsearch_list_route_selectrows(frontend_server, sl_operator, vulnsearch_multiaction):  # pylint: disable=unused-argument
...
def test_vulnsearch_list_route_dt_toolbox_multiactions(frontend_server, sl_operator, vulnsearch_multiaction):  # pylint: disable=unused-argument
...
def test_vulnsearch_list_route_dt_toolbox_freetag(frontend_server, sl_operator, vulnsearch_multiaction):  # pylint: disable=unused-argument
